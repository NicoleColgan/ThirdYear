...
<body>
    ...
    CREATE<BR>
    <input type ="checkbox" name="operation" value="READONESTUDENT">
    READ ONE STUDENT<br>
    <input type ="checkbox" name="operation" value="READALL">
    READ ALL STUDENTS<br>
    <input type ="checkbox" name="operation" value="UPDATE">
    UPDATE<br>
    <input type ="checkbox" name="operation" value="DELETE">
    DELETE<br>
    <input type ="checkbox" name="operation" value="CHANGEEMAIL">
    CHANGE EMAIL ENDING<br>
